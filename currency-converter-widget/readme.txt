...
Donate link: https://www.currency.wiki/en/
License: GPLv3
License URI: http://www.gnu.org/licenses/gpl.html
Tags: Currency Converter, Exchange Rates, Currency Calcualtor, Currency Exchange, Central Bank Rates, Foreign Exchange, Bitcoin, Currency
...
With international business booming, global tourism ever popular and increasing immigration part of our daily lives, a good [Currency Converter](https://www.currency.wiki/en/converter) can help your site gain the edge over your competitors no matter what field you are in.

The Exchange Rate Widget plugin powered by [Currency Wiki](https://www.currency.wiki/en/) may be exactly the simple but versatile option for the job.
...
Discover how a simple, free WordPress Exchange Rate widget can help create a great user experience and even drive traffic to your page. Check out the [Widget Demo](http://www.currencyconverterplugin.com) to learn more about this amazing Currency Converter plugin.

> <strong>Report Bugs</strong><br>
> Please use  [Currency Wiki on GitHub](https://github.com/currencywiki/currency-converter) or [Email](wordpress@currency.wiki) to report bugs.

= Other info =
Check out the following pages:

* The [Currency Exchange Widget](https://www.currency.wiki/en/exchange-widget).
* Learn [About Currency Wiki](https://www.currency.wiki/en/about) official page.
...
* Example live conversion data for [USD to EUR](https://www.currency.wiki/en/1usd-eur) currency pairs.
